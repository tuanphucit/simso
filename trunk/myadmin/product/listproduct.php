			...
			<table cellspacing="0" cellpadding="0" width="100%" height="100%">
				...
				<tr>
					<td colspan="2" style="padding-bottom:5px">
						<table width="100%" cellpadding="0" cellspacing="0">
							...
							<td class="headlink" align="right"><a target="_blank" href="product/PHP_EXCEL/sample/xls2mysql?&CURMOD=<?=$CURMOD?>"><img src="images/new_f2.png" border="0" title="Import File Excel" align="absmiddle"><br />Import File Excel</a></td>
				...
				<tr>
					<td colspan="2" class="headform">
						...
						<form action="<?=$url?>&action=deleteall" method="post">
							<tr>
								<td width="130" style="font-weight:bold">
								<input type=hidden name="category" value="<?=$CURMOD?>">
									<input type="checkbox" align="left" onClick="checkAll(this)"> 
									<a href="<?=$linktoOrderByName?>"><?=def_danhmuc?> <?=$senderArrow?></a>
								</td>
								<td width="120" style="font-weight:bold"><input type="submit" name="deleteall" value="Xo&#225; t&#7845;t c&#7843;" /></td>
								</form>
