...
switch($action)
{
	...
	case 'update':
		...
		{			
			...
			$values  = "news_name='".$nname."',news_date='".$ndate."',news_image='".$new_image."',news_imagenote='".$imgnote."',news_shortdes='".$shortdes."',news_detail='".$detail."',news_istop='".$istop."',news_ihome='".$ihome."',news_ihight='".$ihight."',news_visited='".$visited."',news_order='".$order."',news_view='".$view."'";
		...
		elseif($isSave==NULL)
		{
			...
			$fields = "news_name,news_date,news_image,news_imagenote,news_shortdes,news_detail,news_istop,news_ihome,news_ihight,news_visited,news_order,news_view,modules_id,language_id";
			$values  = "'".$nname."','".$ndate."','".$new_image."','".$imgnote."','".$shortdes."','".$detail."','".$istop."','".$ihome."','".$ihight."','".$visited."','".$order."','".$view."','".$CURMOD."','".$LANG."'";
	...
	case 'edit':
		...
		if($CURID!=NULL)
		{
			...
			$ihight = $checked[$sql->farray["news_ihight"]];
