	...
	<tr>
		<td width="100%">
			<table cellspacing="0" cellpadding="0" width="100%" height="100%">
				<tr height="60">
					<td colspan="2" class="modulehead"><img src="images/config_002.png" align="left"><?=$parentPage?></td>
				</tr>
				<tr>
							...
							<tr>
								...
								<td nowrap valign="bottom">							
									...
									<div>
										...
										<input name="KWD" class="textbox" size="25" maxlength="180" accesskey="k" value="<?=$KWD?>" onKeyUp="telexingVietUC(this)"> &nbsp;&nbsp;&nbsp;
										<font style="font-weight:bold; color:#993300">Item type: </font>
										<select name="CATE" onChange="document.frmSearch.submit()" style="width:90px">
											<option value="" selected> -- All -- </option>
											<option value="0">Content of page</option>
											<option value="1">A part of page</option>
										</select>
										<script language="javascript">document.frmSearch.CATE.value = '<?=$CATE?>'</script>
				...
				<tr>
					<td colspan="2" class="headform">
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td width="255" style="font-weight:bold">
								...
								<td width="65" align="center" style="font-weight:bold" nowrap><a href="?module=<?=$module?>&orderBy=order&vArrow=<?=$toArrow?>&KWD=<?=$KWD?>"><?=def_thutu?> <?=$orderArrow?></a></td>
