  ...
  <tr>
	  ...
	  <td width="578" valign="top" align="center">
			<table border="0" cellspacing="0" cellpadding="0" width="92%" valign="top">
				...
				<tr>
					<td style="listOthers"><?=$otherItems?></td></td>
				</tr>
			</table>
	 </td>
