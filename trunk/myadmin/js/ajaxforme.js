var ajaxpagefetcher={
loadingmessage: '<div style="padding:20px 10px 20px 10px" align="center"><img src="<?=$_IMG_DIR?>/loading.gif" width="16" height="16"><br>Loading data, please wait...</div>',
exfilesadded: "",
...
load:function(containerid, pageurl)
{
