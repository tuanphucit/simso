...
{
	myWidth = 630; // Default width in px
}
else
{
	myWidth = 200; // Default width in px
}
...
Modalbox.Methods = {
	...
	options: {
		...
		width: myWidth, // Default width in px
	...
	show: function(content, options) {
		...
		{ // First modal box appearing
			...
			this.MBcontent.style.scrollbarFaceColor = '#BABF91';
			this.MBcontent.style.scrollbarTrackColor = '#D9DAA8';
			this.MBcontent.style.scrollbarShadowColor = '#BABF91';
			this.MBcontent.style.scrollbarArrowColor = '#D2D8AF';
			this.MBcontent.style.scrollbarDarkShadowColor = '#BABF91';
			this.MBcontent.style.scrollbarHighlightColor = '#BABF91';
		}
	...
	resize: function(byWidth, byHeight, options) { // Change size of MB without loading content
		...
		var cWidth = Element.getWidth(this.MBcontent);
		var newHeight = ((wHeight - hHeight + byHeight) < cHeight) ? (cHeight + hHeight - wHeight) : byHeight;
		var newWidth = ((wWidth + byWidth) < cWidth) ? (cWidth - wWidth) : byWidth;
		this.setOptions(options); // Passing callbacks
		new Effect.ScaleBy(this.MBwindow, newWidth, newHeight, {
	...
	_setOverlay: function () {
		if (navigator.appVersion.match(/\bMSIE\b/)) {
			...
			window.scrollTo(0,0); // Disable scrolling on top for IE7
		}
	},
...
Object.extend(Object.extend(Effect.ScaleBy.prototype, Effect.Base.prototype), {
  ...
  setup: function() {
    ...
    this.originalTop  = this.element.offsetTop + Modalbox._init.initScrollY;
