		...
		<td width="100%">					
			<div id="MAIN" class="maindiv" style="width: 200px; height: 200px; position:relative; border:0px">
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="rowinfohead" nowrap width="30%"><b><?=def_chuyende?>:</b></td>
					...
					<!--<tr>
						<td class="rowinfohead" nowrap width="30%"><?=def_nguon?>:</td>
						<td width="70%" class="rowinfo">
							<input type="text" name="source" size="25" maxlength="255" value="<?=$source?>" readonly="1" class="textbox">
							<font color="#FF3300">*</font>
						</td>
					</tr>-->
					<tr>
					...
					<tr>
						<td class="rowinfohead">Sim Vip: </td>
						<td class="rowinfo"><input name="vip" type="checkbox" <?=$cur_vip?> value="1" enable></td>
					</tr>
