							...
							<tr>
								...
								<td nowrap valign="bottom">							
									...
									<div>
										...
										<font style="font-weight:bold; color:#993300"><?=def_xemtheovitri?>: </font>
										<select name="POS" onChange="document.frmSearch.submit()">
											<option value="" selected> -- <?=def_tatca?> -- </option>
											<option value="0"><?=def_caclogotrenbanner?></option>
											<option value="1"><?=def_caclogocotbenphai?></option>
										</select>
										<script language="javascript">document.frmSearch.POS.value = '<?=$POS?>'</script>
						...
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td width="275" style="font-weight:bold">
									...
									<a href="?module=<?=$module?>&orderBy=name&vArrow=<?=$toArrow?>&KWD=<?=$KWD?>&POS=<?=$POS?>"><?=def_danhmuc?> <?=$senderArrow?></a>
								</td>
								<td width="65" align="center" style="font-weight:bold" nowrap><a href="?module=<?=$module?>&orderBy=order&vArrow=<?=$toArrow?>&KWD=<?=$KWD?>&POS=<?=$POS?>"><?=def_thutu?> <?=$orderArrow?></a></td>
