  ...
  <tr>
    <td valign="top">
			<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="adminform">
				...
				<tr>
					<td class="rowform" nowrap>Họ tên: </td>
					<td class="rowform"><input name="fullname" type="text" value="<?=$fullname?>" class="textbox"></td>
				</tr>
				<tr>
					<td class="rowform" nowrap>Email: </td>
					<td class="rowform"><input name="email" type="text" value="<?=$email?>" class="textbox"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="rowform" valign="top" style="padding-top: 50px">Ý kiến: </td>
					<td class="rowform"><?=$oFCKeditor_1->Create()?></td>
				</tr>
				<tr>
					<td class="rowform" valign="top" style="padding-top: 50px">Trả lời: </td>
