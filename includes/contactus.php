...
{
	$title = "Khach hang lien he tu ".str_replace('http://','',$config["domain"]);
	$from = $email;
	...
	<table width="600" cellpadding="5" cellspacing="1" align="center">
		<tr bgcolor="#ECF5FF"><td width="20%" nowrap><b>'.$define["var_hovaten"].':</b></td><td width="70%">'.$yourName.'</td></tr>
		<tr bgcolor="#ECF5FF"><td nowrap><b>'.$define["var_email"].':</b></td><td>'.$yourEmail.'</td></tr>
		<tr bgcolor="#ECF5FF"><td nowrap><b>'.$define["var_tieude"].':</b></td><td>'.$yourTitle.'</td></tr>
		<tr bgcolor="#ECF5FF"><td nowrap><b>'.$define["var_noidung"].':</b></td><td>'.$yourMess.'</td></tr>
	</table>
	</body>
	</html>';
	...
	$mail->AddAddress($config["site_email"],"coalimex.com.vn");	 	// Dia chi email va ten nhan
	...
	<table width="100%" height="150" align="center" cellpadding="3" cellspacing="0">
		<tr height="25">
			<td style="font-size:14px; font-weight:bold; padding:15px 0px 10px 0px">'.$define["var_lienhevoichungtoi"].'</td>
		</tr>
		<tr>
...
else
{
	...
	_SESSION_REGISTER("isSent");
?>
<form name="suggestionFrm" action="<?=$_URL_BASE?>/includes/contactus.php?itemId=<?=$itemId?>" method="post" onSubmit="return doSugFrmSubmit()">
<table width="100%" align="center" cellpadding="3" cellspacing="0">
	<tr>
		<td colspan="2" style="font-size:14px; font-weight:bold; padding:15px 0px 10px 0px"><?=$define["var_lienhevoichungtoi"]?></td>
	</tr>
	<tr>
